...
func fetchForecast(cityName: String, completion: @escaping(Result<Forecast, Error>)-> ()){
    ...
    let urlStr = "https://api.openweathermap.org/data/2.5/forecast?q=\(cityName)&appid=c743b6f0525323b2e938723c9ca76ef0&units=metric&lang=kr"
...
func fetchForecast(cityId: Int, completion: @escaping(Result<Forecast, Error>)-> ()) {
    ...
    let urlStr = "https://api.openweathermap.org/data/2.5/forecast?id=\(cityId)&appid=c743b6f0525323b2e938723c9ca76ef0&units=metric&lang=kr"
...
func fetchForecast(location: CLLocation, completion: @escaping(Result<Forecast, Error>)-> ()){
    ...
    let urlStr = "https://api.openweathermap.org/data/2.5/forecast?lat=\(location.coordinate.latitude)&lon=\(location.coordinate.longitude)&appid=c743b6f0525323b2e938723c9ca76ef0&units=metric&lang=kr"
